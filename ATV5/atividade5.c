const int POT1_MIN = 833;    // Insira o valor mínimo lido no A0
const int POT1_MAX = 190; // Insira o valor máximo lido no A0
const int POT2_MIN = 413;    // Insira o valor mínimo lido no A1
const int POT2_MAX = 87; // Insira o valor máximo lido no A1
